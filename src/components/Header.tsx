...
export const Header = ({ showEventTypesHeader = false }: HeaderProps) => {
  ...
  // Show event types header for main page and event editing pages
  const shouldShowEventTypesHeader = showEventTypesHeader || location.pathname.includes('/event/');
          ...
          <div className="relative">
            ...
            {showProfileDropdown && (
              <>
                ...
                />
                <div className="absolute right-0 top-full mt-1 w-48 bg-popover border border-border rounded-lg shadow-lg animate-scale-in z-50">
                  <div className="py-1">
