...
export const EventAvailability = () => {
  ...
  const schedules = [
    { 
      ...
      workingHours: [
        ...
        { day: 'Saturday', start: 'Unavailable', end: '' },
        { day: 'Sunday', start: 'Unavailable', end: '' },
      ]
    },
    { 
      id: 'business-hours', 
      ...
      workingHours: [
        ...
        { day: 'Tuesday', start: '8:00 am', end: '6:00 pm' },
        { day: 'Wednesday', start: '8:00 am', end: '6:00 pm' },
        { day: 'Thursday', start: '8:00 am', end: '6:00 pm' },
        { day: 'Friday', start: '8:00 am', end: '6:00 pm' },
    ...
    { 
      ...
      workingHours: [
        { day: 'Monday', start: '10:00 am', end: '8:00 pm' },
        { day: 'Tuesday', start: '10:00 am', end: '8:00 pm' },
        { day: 'Wednesday', start: '11:00 am', end: '7:00 pm' },
        { day: 'Thursday', start: '10:00 am', end: '8:00 pm' },
        { day: 'Friday', start: '9:00 am', end: '6:00 pm' },
        { day: 'Saturday', start: '12:00 pm', end: '8:00 pm' },
        { day: 'Sunday', start: '1:00 pm', end: '6:00 pm' },
      ]
    }
  ];
  ...
  return (
    <div className="p-8 max-w-4xl space-y-8">
      <div>
        <h2 className="text-xl font-semibold text-foreground mb-6">Availability</h2>
        ...
        <div className="bg-card border border-border rounded-lg p-6">
          <div className="space-y-4">
            {currentSchedule.workingHours.map((schedule, index) => (
              <div key={index} className="flex items-center justify-between py-3">
                <div className="w-28 text-foreground font-medium">
                  {schedule.day}
                </div>
                <div className="flex items-center space-x-4 text-muted-foreground">
                  {schedule.start === 'Unavailable' ? (
