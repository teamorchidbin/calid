...
export const EventLimits = () => {
  ...
  return <div className="p-6 max-w-4xl space-y-6">
      ...
      <div className="border-b border-gray-200 pb-6">
        <h3 className="font-semibold text-gray-900 mb-4 text-base">Before event</h3>
        
        <div className="grid grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Buffer time</label>
            <select value={settings.beforeEvent.bufferTime} onChange={e => updateSetting('beforeEvent', 'bufferTime', e.target.value)} className="w-full px-3 py-2 border border-gray-300 focus:ring-2 focus:ring-blue-500 rounded-md">
          ...
          <div>
            ...
            })} className="flex-1 px-3 py-2 border border-gray-300 focus:ring-2 focus:ring-blue-500 rounded-md" />
      ...
      {/* After Event */}
      <div className="border-b border-gray-200 pb-6">
        <h3 className="font-semibold text-gray-900 mb-4 text-base">After event</h3>
        
        <div className="grid grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Buffer time</label>
            <select value={settings.afterEvent.bufferTime} onChange={e => updateSetting('afterEvent', 'bufferTime', e.target.value)} className="w-full px-3 py-2 border border-gray-300 focus:ring-2 focus:ring-blue-500 rounded-md">
              <option value="no-buffer">No buffer time</option>
              <option value="15">15 minutes</option>
              <option value="30">30 minutes</option>
            </select>
          ...
          <div>
            ...
            <select value={settings.afterEvent.timeSlotIntervals} onChange={e => updateSetting('afterEvent', 'timeSlotIntervals', e.target.value)} className="w-full px-3 py-2 border border-gray-300 focus:ring-2 focus:ring-blue-500 rounded-md">
